...
<div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-8">
    <div>
        ...
        <p class="text-white/80">Sales completed this month</p>
    </div>
    <div class="flex flex-wrap gap-3">
        <a href="{{ route('reports.monthly.pdf') }}" class="inline-flex items-center gap-2 rounded-2xl bg-blue-600 px-5 py-3 text-sm font-medium text-white transition hover:bg-blue-700">
